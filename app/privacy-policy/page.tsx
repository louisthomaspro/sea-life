    ...
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to SeaLife.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to SeaLife, accessible from{" "}
            <a href="https://sea-life.vercel.app" rel="external nofollow noopener" target="_blank">
      ...
      <ul>
        <li>
          ...
          <a href="https://sea-life.vercel.app/contact" rel="external nofollow noopener" target="_blank">
            https://sea-life.vercel.app/contact
          </a>
        </li>
      </ul>
    </>
