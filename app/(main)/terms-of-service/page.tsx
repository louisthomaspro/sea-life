export default function TermsOfServicePage() {
  return (
    <>
      ...
      <p>Welcome to SeaLife!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use of SeaLife's Website, located at
        https://sea-life.vercel.app.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use SeaLife if you
      ...
      <p>
        We employ the use of cookies. By accessing SeaLife, you agreed to use cookies in agreement with the SeaLife's
        Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, SeaLife and/or its licensors own the intellectual property rights for all material on
        SeaLife. All intellectual property rights are reserved. You may access this from SeaLife for your own personal
        use subjected to restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from SeaLife</li>
        <li>Sell, rent or sub-license material from SeaLife</li>
        <li>Reproduce, duplicate or copy material from SeaLife</li>
        <li>Redistribute content from SeaLife</li>
      </ul>
      ...
      <p>
        ...
        areas of the website. SeaLife does not filter, edit, publish or review Comments prior to their presence on the
        website. Comments do not reflect the views and opinions of SeaLife,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, SeaLife shall not be liable for the Comments or for any liability, damages or expenses caused
        and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
      </p>

      <p>
        SeaLife reserves the right to monitor all Comments and to remove any Comments which can be considered
      ...
      <p>
        You hereby grant SeaLife a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce
      ...
      <p>
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of SeaLife;
      ...
      <p>
        ...
        you must inform us by sending an e-mail to SeaLife. Please include your name, your organization name, contact
      ...
      <p>No use of SeaLife's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
